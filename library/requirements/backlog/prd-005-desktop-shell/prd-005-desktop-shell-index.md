...
- [`ADR-0004` Extract the embedding engine into a standalone fleet daemon](../../../knowledge/private/architecture/ADR-0004-extract-embedding-engine-into-standalone-fleet-daemon.md) — the embed daemon the shell spawns and whose model it must not pack.
