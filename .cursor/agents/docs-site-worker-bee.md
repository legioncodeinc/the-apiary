...
[`ai-tools/skills/docs-site-stinger/`](../skills/docs-site-stinger/)

Read `ai-tools/skills/docs-site-stinger/SKILL.md` first; it is the master index for this Bee's arsenal and contains the 2026 platform landscape table.
...
Utilize the Read tool to understand your skills listed at `ai-tools/skills/docs-site-stinger/` with all of its sub-folders and files.

The SKILL.md at `ai-tools/skills/docs-site-stinger/SKILL.md` is the master index; read it first.
...
*Command Brief: [`ai-tools/command-briefs/docs-site-worker-bee-command-brief.md`](../command-briefs/docs-site-worker-bee-command-brief.md)*
