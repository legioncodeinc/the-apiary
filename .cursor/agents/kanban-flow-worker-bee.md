...
[`ai-tools/skills/kanban-flow-stinger/`](../skills/kanban-flow-stinger/)

Read `ai-tools/skills/kanban-flow-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
3. **Load the relevant guide** from `ai-tools/skills/kanban-flow-stinger/guides/`. The guide owns the procedure; this Bee delegates depth to the Stinger.
...
Utilize the Read tool to understand your skills listed at `ai-tools/skills/kanban-flow-stinger/` with all of its sub-folders and files.

The SKILL.md at `ai-tools/skills/kanban-flow-stinger/SKILL.md` is the master index — read it first.
...
*Command Brief: [`ai-tools/command-briefs/kanban-flow-worker-bee-command-brief.md`](../command-briefs/kanban-flow-worker-bee-command-brief.md)*
