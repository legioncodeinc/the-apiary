...
The Command Brief is at `ai-tools/command-briefs/preact-worker-bee-command-brief.md`. The research foundation is at `research/research-summary.md`, synthesized from 12 files across official Preact, Astro, Fresh, and signals documentation (2025-2026 window).
